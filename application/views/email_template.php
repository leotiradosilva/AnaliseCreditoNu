        ...
        <td class="container" width="600" style="padding-top: 20px;">
            <div class="content">
                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <img style="margin-left: -1px; width:600px;max-width: 600px;" class="cabecalho" src="<?= base_url('assets/email/cabecalho.png?v=3') ?>">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;background-color: #004365; text-align: right;padding:20px 25px 15px 0px">
                            <img valign="middle" style="max-width: 605px;"
                                 src="<?= base_url('assets/email/logo-rodape.png') ?>" alt="">
                        </td>
                    </tr>
                    </tbody>
                </table>
                            ...
                            <ul style="list-style: none;text-align: center;">
                                <li style="display: inline-block;">
                                    <a target="_blank" href="https://www.facebook.com/gcbinvestimentos/?fref=ts">
                                        <img src="<?= base_url('assets/email/instagram.png') ?>" alt="">
                                    </a>
                                </li>
                                <li style="display: inline-block;">
                                    <a target="_blank" href="https://www.facebook.com/gcbinvestimentos/?fref=ts">
                                        <img src="<?= base_url('assets/email/facebook.png') ?>" alt="">
                                    </a>
                                </li>
                            </ul>
                        </td>
