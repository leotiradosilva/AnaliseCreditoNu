...
<body>
    ...
    <p class='border'>
        Boletim de subscrição (“Boletim de Subscrição”) referente à emissão de debêntures subordinadas não conversíveis em ações, em 16 (dezesseis) séries, para distribuição privada da 
        FMI SECURITIZADORA S.A. (Emissora), regulamentada pelo Instrumento Particular de Escritura de Segunda Emissão de Debêntures, Subordinadas Não Conversíveis em Ações, em 16 (dezesseis) séries, 
        para Distribuição Privada, da Emissora (“Escritura de Emissão”) aprovada pela Assembleia Geral Extraordinária da Emissora realizada em 07 de abril de 2020, a ser registrada na Junta 
        Comercial do Estado de São Paulo (JUCESP) nos termos e no prazo definido no artigo 6o, incisos I e II, da Medida Provisória n. 931, de 30/03/2020. Uma cópia fiel da Escritura de Emissão 
        encontra-se, nesta data, disponível em <a target="_blank" href="<?= FMI_SITE ?>pdf/escritura.pdf">www.fmisa.com.br/escrituradesegundaemissao</a> e registrada em 09/04/2020, 
        na ata notarial de fls. 153, 154, 155, 156, 157 e 158 do Livro n. 506 do 30o Tabelião de Notas da Comarca da Capital de São Paulo. 
        <br><br>
    ...
    <p class='border'>
        ...
        1.	Eu, Debenturista Subscritor, declaro que tenho pleno conhecimento da Escritura de Emissão, de seu inteiro teor e de todos os seus termos e condições, 
        vinculando-me a ela, pelo presente ato, como a parte lá definida como “Debenturista”. 
        <br /><br />
        ...
        7.  Com exceção do infra identificado no item 7.1, eu, Debenturista, dou quitação total e irrevogável dos Créditos da Primeira Emissão (soma do Valor Nominal Unitário de todas 
        debêntures adquiridas por mim na Primeira Emissão somado ao valor oriundo de Capitalização da Remuneração Líquida  havida também na Primeira Emissão e somado, ainda, ao valor de 
        toda eventual Remuneração Líquida vencida e não paga até a presente data), bem como de todos os valores e obrigações desta, nada mais tendo a demandar, pretender ou receber em 
        relação à Emissora ou à Primeira Emissão (todo processo de circulação de debêntures e acontecimentos decorrentes da emissão regrada originalmente pelo “Instrumento Particular de 
        Escritura de Emissão de Debêntures da Espécie com Garantias Reais, Não Conversíveis em Ações, em 10 (dez) Séries, para distribuição Privada, da FMI Securitizadora S.A”, 
        aprovado pela Assembleia Geral Extraordinária de acionistas da Companhia realizada em 21/07/2015). Para todos os efeitos, reconheço que o valor atual dos Créditos da Primeira 
        Emissão equivale ao valor indicado na tabela do item III acima, valor este ora integralizado, após subtraído o valor indicado no item 7.1 abaixo. 
        <br><br>

        7.1   Na Primeira Emissão, eu, Debenturista, mantenho apenas a quantidade de <?= $cliente->quantidade_restante > 0 ? $cliente->quantidade_restante : '0' ?> 
        Debêntures, com Valor Nominal Unitário somado, de todas estas, de R$ <?= $cliente->valor_restante > 0 ? $cliente->valor_restante : '0,00' ?>.
        <br><br>
